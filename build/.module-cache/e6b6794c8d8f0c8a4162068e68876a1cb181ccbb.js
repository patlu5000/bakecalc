  ...
  getInitialState: function() {
    ...
    render: function() {
      return (
          ...
          ItemsBox({id: "ingredients-box", name: "Ingredients", inputsComponent: IngredientInputs, activeItems: this.state.ingredients, presetItems: PRESET_INGREDIENTS, onUserInput: this.handleIngredientsInput}), 
          ItemsBox({id: "supplies-box", name: "Supplies", inputsComponent: SupplyInputs, activeItems: this.state.supplies, presetItems: PRESET_SUPPLIES, onUserInput: this.handleSuppliesInput}), 
...
var ItemsBox = React.createClass({displayName: 'ItemsBox',
  handleItemSelect: function(item) {
    ...
    render: function() {
      ...
      return (
          React.DOM.div({id: "ingredients-box", className: "panel input-box"}, 
