...
var CalculationBox = React.createClass({displayName: 'CalculationBox',
  render: function() {
    ...
    return (
      ...
      CalculationItem({itemTotal: suppliesTotal}), 
      CalculationItem({itemTotal: timeTotal}), 
      CalculationItem({itemTotal: overheadTotal}), 
      CalculationItem({itemTotal: deliveryTotal})
      )
      )
      );
  }
...
var CalculationItem = React.createClass({displayName: 'CalculationItem',
  render: function() {
    if (typeof this.props.itemTotal != 'undefined' && itemTotal > 0) {
