  ...
  handleIngredientSelect: function(ingredient) {
    ...
    render: function() {
      var ingredientLinks = _.difference(PRESET_INGREDIENTS, this.props.activeIngredients).map(function(ingredient) {
        return (
          IngredientLink({onItemSelect: this.handleIngredientSelect, item: ingredient})
          );
      }.bind(this));
      ...
      return (
          ...
          ingredientLinks, 
          IngredientLink({onItemSelect: this.handleIngredientSelect, ingredient: { quantity: 1, name: "", cost: null}})
          )
          );
    }
});
