    ...
    render: function() {
      if ( _.contains(_.pluck(PRESET_INGREDIENTS, 'key'), this.props.item.key)) {
        ...
        if (this.props.item.unit) {
          var name = React.DOM.span(null, " ", this.props.item.unit + 's', " of ", React.DOM.input({hidden: true, defaultValue: this.props.item.name, type: "text", ref: "ingredientNameInput", onChange: this.handleChange}), React.DOM.a({href: this.props.item.amazonUrl, className: "item-name"}, this.props.item.name), " at ");
        } else {
          var name = React.DOM.span(null, " ", React.DOM.input({hidden: true, defaultValue: this.props.item.name, type: "text", ref: "ingredientNameInput", onChange: this.handleChange}), React.DOM.a({href: this.props.item.amazonUrl, className: "item-name"}, this.props.item.name), " at ");
        }
  ...
  handleChange: function(event) {
    ...
    render: function() {
      if (_.contains(_.pluck(PRESET_SUPPLIES, 'key'), this.props.item.key)) {
        ...
        var name = React.DOM.span(null, React.DOM.input({hidden: true, defaultValue: this.props.item.name, type: "text", ref: "supplyNameInput", onChange: this.handleChange}), " ", React.DOM.a({href: this.props.item.amazonUrl, className: "item-name"}, this.props.item.name), " at ");
