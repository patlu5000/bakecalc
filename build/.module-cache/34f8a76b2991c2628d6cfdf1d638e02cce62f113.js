...
"baking-powder": { "name": "baking powder", "unit": "teaspoons", "cost": 0.08, "quantity": 1 }, 
"butter": { "name": "butter", "unit": "cups", "cost": 0.5, "quantity": 1 }, 
"chocolate-chips": { "name": "chocolate chips", "unit": "cups", "cost": 1.1, "quantity": 1 }, 
"cinnamon": { "name": "cinnamon", "unit": "teaspoons", "cost": 0.06, "quantity": 1 }, 
"cocoa": { "name": "cocoa", "unit": "cups", "cost": 1.54, "quantity": 1 }, 
"eggs": { "name": "eggs", "unit": null, "cost": 0.25, "quantity": 1 }, 
"flour": { "name": "flour", "unit": "cups", "cost": 0.1, "quantity": 1 }, 
"margarine": { "name": "margarine", "unit": "cups", "cost": 0.5, "quantity": 1 }, 
"milk": { "name": "milk", "unit": "cups", "cost": 0.17, "quantity": 1 }, 
"shortening": { "name": "shortening", "unit": "cups", "cost": 0.66, "quantity": 1 }, 
"sugar": { "name": "sugar", "unit": "cups", "cost": 0.3, "quantity": 1 }, 
"vanilla": { "name": "vanilla", "unit": "teaspoons", "cost": 0.04, "quantity": 1 }, 
"vegetable-oil": { "name": "vegetable oil", "unit": "cups", "cost": 0.46, "quantity": 1 }, 
"yeast": { "name": "yeast", "unit": "packages", "cost": 0.51, "quantity": 1 } 
};
...
var Calculator = React.createClass({displayName: 'Calculator',
  ...
  handleIngredientChange: function(changes) {
    ...
    ingredient = _.reject(ingredients, function(ing){ return ing.key == changes.key });
    this.setState({ activeIngredients: ingredients });
  },
