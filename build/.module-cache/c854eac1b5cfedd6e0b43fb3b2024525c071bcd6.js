  ...
  handleChange: function(event) {
    ...
    render: function() {
      return (
        ...
        React.DOM.p(null, "The current federal reimbursement rate for mileage is $0.56 per mile, which is a good place to start. Don't forget to charge for the entire round-trip!")
        )
        );
    }
});
