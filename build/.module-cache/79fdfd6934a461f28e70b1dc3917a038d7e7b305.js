...
var IngredientInputs = React.createClass({displayName: 'IngredientInputs',
  handleChange: function(event) {
    ...
    render: function() {
      ...
      if (typeof this.props.ingredient.unit == "undefined") {
        return(React.DOM.input({defaultValue: this.props.ingredient.name, type: "text", className: "name", onChange: this.handleChange}));
      } else {
        return(React.DOM.input({defaultValue: this.props.ingredient.quantity, type: "number", className: "quantity", onChange: this.handleChange}));
      }
      return (
        React.DOM.div(null, 
        firstInput, 
