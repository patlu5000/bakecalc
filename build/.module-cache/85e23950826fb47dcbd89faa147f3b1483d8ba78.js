  ...
  handleChange: function(event) {
    ...
    render: function() {
      if ( _.contains(_.pluck(PRESET_INGREDIENTS, "key"), this.props.item.key)) {
        var firstInput = React.DOM.input({defaultValue: this.props.item.quantity, type: "number", className: "form-control input-sm", type: "number", ref: "ingredientQuantityInput", onChange: this.handleChange});
        ...
        var firstInput = React.DOM.input({defaultValue: this.props.item.name, type: "text", className: "form-control input-sm", ref: "ingredientNameInput", onChange: this.handleChange});
        var middleText = " at ";
        var endText = "";
  ...
  handleChange: function(event) {
    ...
    render: function() {
      return (
        ...
        React.DOM.input({type: "number", className: "form-control", ref: "timeHoursInput", onChange: this.handleChange}), " hours at",  
        React.DOM.input({type: "number", className: "form-control", ref: "timeWageInput", onChange: this.handleChange}), " an hour"
        )
        );
    }
});
  ...
  handleChange: function(event) {
    ...
    render: function() {
      return(
        ...
        React.DOM.input({type: "number", className: "form-control", ref: "overheadInput", onChange: this.handleChange})
        )
        );
    }
});
  ...
  handleChange: function(event) {
    ...
    render: function() {
      return (
        ...
        React.DOM.input({type: "number", className: "form-control", ref: "deliveryMilesInput", onChange: this.handleChange}), " miles at",  
        React.DOM.input({type: "number", className: "form-control", ref: "deliveryRateInput", onChange: this.handleChange}), " per mile"
        )
        );
    }
});
