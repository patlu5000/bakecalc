...
{ key: "baking-powder", name: "baking powder", unit: "teaspoon", cost: 0.08 }, 
  ...
  handleChange: function(event) {
    ...
    render: function() {
      if ( _.contains(_.pluck(PRESET_INGREDIENTS, 'key'), this.props.item.key)) {
        ...
        var costAppend = (this.props.item.unit || 'each');
        React.DOM.span({className: "input-group-addon"}, "/", React.DOM.sub(null, this.props.item.unit || 'each'))
      } else {
