  ...
  handleChange: function(event) {
    ...
    render: function() {
      ...
      if ( _.contains(_.pluck(PRESET_INGREDIENTS, "key"), this.props.ingredient.key)) {
        var firstInput = React.DOM.input({hidden: true, defaultValue: this.props.ingredient.quantity, type: "number", ref: "ingredientQuantityInput", onChange: this.handleChange});
