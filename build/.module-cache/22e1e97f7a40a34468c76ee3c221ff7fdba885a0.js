  ...
  handleIngredientSelect: function(ingredient) {
    ...
    render: function() {
      ...
      return (
          ...
          ingredientLinks, 
          IngredientLink({onIngredientSelect: this.handleIngredientSelect, ingredient:  { quantity: 1} })
          )
          );
    }
});
  ...
  handleChange: function(event) {
    ...
    render: function() {
      if ( _.contains(_.pluck(PRESET_INGREDIENTS, "key"), this.props.ingredient.key)) {
        var firstInput = React.DOM.input({defaultValue: this.props.ingredient.quantity, type: "number", ref: "ingredientsQuantityInput", onChange: this.handleChange});
