...
var IngredientInputs = React.createClass({displayName: 'IngredientInputs',
  render: function() {
    ...
    return (
      React.DOM.div(null, 
      React.DOM.input({value: "0", type: "number", className: "ingredient-quantity"}), middleText, 
      React.DOM.input({value: this.props.ingredient.price.toString(), type: "number", className: "ingredient-price"}), endText
      )
    );
  }
});
