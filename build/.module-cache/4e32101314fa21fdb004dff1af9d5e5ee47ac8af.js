...
var CalculationBox = React.createClass({displayName: 'CalculationBox',
  ...
  render: function() {
    ...
    if (grandTotal > 0) {
      ...
      var panelFooter = React.DOM.div({className: "panel-footer"}, React.DOM.h4(null, "You should charge: ", React.DOM.strong({className: "pull-right"}, "$", grandTotal)), React.DOM.a({onClick: this.handleClickReset, href: "#", className: "pull-right"}, "reset"))
    } else {
