...
var IngredientInputs = React.createClass({displayName: 'IngredientInputs',
  ...
  render: function() {
    ...
    return (
      React.DOM.div(null, 
      "if (typeof this.props.ingredient.unit == \"undefined\") ", 
        React.DOM.input({defaultValue: this.props.ingredient.name, type: "text", className: "name", onChange: this.handleChange}), 
      " else", 
      React.DOM.input({defaultValue: this.props.ingredient.quantity, type: "number", className: "quantity", onChange: this.handleChange}), 
      "}", 
      middleText, 
