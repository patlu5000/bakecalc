  ...
  getInitialState: function() {
    ...
    render: function() {
      ...
      return (
          ...
          IngredientsBox({presetIngredients: INGREDIENTS, activeIngredients: this.state.ingredients, onUserInput: this.handleIngredientsInput}), 
          SuppliesBox({presetSupplies: SUPPLIES, activeSupplies: this.state.supplies, onUserInput: this.handleSuppliesInput}), 
...
var SuppliesBox = React.createClass({displayName: 'SuppliesBox',
  handleSupplySelect: function(supply) {
    ...
    render: function() {
      var supplyLinks = _.difference(this.props.presetSupplies, this.props.activeSupplies).map(function(supply) {
        return (
...
var IngredientInputs = React.createClass({displayName: 'IngredientInputs',
  handleChange: function(event) {
    ...
    render: function() {
      if ( _.contains(_.pluck(INGREDIENTS, "key"), this.props.ingredient.key)) {
