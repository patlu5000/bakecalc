...
var IngredientInputs = React.createClass({displayName: 'IngredientInputs',
  ...
  render: function() {
    ...
    return (
      React.DOM.div(null, 
      React.DOM.input({defaultValue: this.props.ingredient.quantity, type: "number", className: "quantity", onChange: handleChange}), middleText, 
      React.DOM.input({defaultValue: this.props.ingredient.cost, type: "number", className: "price", onChange: handleChange}), endText
      )
    );
  }
});
