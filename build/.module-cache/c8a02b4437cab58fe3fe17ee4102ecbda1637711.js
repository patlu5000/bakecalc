...
var CalculationBox = React.createClass({displayName: 'CalculationBox',
  render: function() {
    ...
    var grandTotal = (ingredientsTotal + suppliesTotal + timeTotal + overheadTotal + deliveryTotal)
    return (
      React.DOM.div({className: "panel panel-default calculation-box"}, 
      React.DOM.ul({className: "list-group"}, 
      React.DOM.li({className: "list-group-item"}, ingredientsTotal), 
      React.DOM.li({className: "list-group-item"}, suppliesTotal), 
      React.DOM.li({className: "list-group-item"}, timeTotal), 
      React.DOM.li({className: "list-group-item"}, overheadTotal), 
      React.DOM.li({className: "list-group-item"}, deliveryTotal)
      )
      )
      );
  }
...
var CalculationItem = React.createClass({displayName: 'CalculationItem',
  render: function() {
    if (itemTotal > 0) {
      return (React.DOM.li({className: "list-group-item"}, itemTotal));
    } else {
      return null;
    }
  }
