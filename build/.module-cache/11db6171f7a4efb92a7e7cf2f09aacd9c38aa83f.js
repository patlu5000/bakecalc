  ...
  handleChange: function(event) {
    ...
    render: function() {
      if (_.contains(_.pluck(PRESET_SUPPLIES, "key"), this.props.item.key)) {
        var firstInput = React.DOM.input({defaultValue: this.props.item.quantity, className: "form-control", type: "number", ref: "supplyQuantityInput", onChange: this.handleChange});
        ...
        var firstInput = React.DOM.input({defaultValue: this.props.item.name, className: "form-control", type: "text", ref: "supplyNameInput", onChange: this.handleChange});
        var middleText = " at ";
      ...
      return (
        ...
        React.DOM.input({defaultValue: this.props.item.cost, className: "form-control input-sm", type: "number", ref: "supplyCostInput", onChange: this.handleChange})
        ), 
        hiddenInput
        )
        );
