...
var IngredientInputs = React.createClass({displayName: 'IngredientInputs',
  ...
  render: function() {
    ...
    return (
      React.DOM.div(null, 
      React.DOM.input({defaultValue: this.props.ingredient.quantity, type: "number", className: "quantity"}), middleText, 
      React.DOM.input({defaultValue: this.props.ingredient.cost, type: "number", className: "price"}), endText
      )
    );
  }
});
